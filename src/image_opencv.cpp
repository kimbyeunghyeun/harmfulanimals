                ...
                for (j = 0; j < classes; ++j) {
                    ...
                    if (dets[i].prob[j] > thresh && show) {
                        if (class_id < 0) {
                            ...
                            if (dets[i].prob[j] * 100 >= 45) {
                                Serial* SP = new Serial("\\\\.\\COM3");
                                if (strcmp(names[j], "boar") == 0) {
                                    SP->WriteData("2", 1);
                                    SP->~Serial();
                                }
                                else if (strcmp(names[j], "fire") == 0) {
                                    SP->WriteData("4", 1);
                                    SP->~Serial();
                                }
                                else if (strcmp(names[j], "human") == 0) {
                                    SP->WriteData("1", 1);
                                    SP->~Serial();
                                }
                                ...
                                sprintf(sql3, "INSERT INTO custom(count, date, type) VALUES(1, '%s', '%s');", datetime, names[j]); // 새로운 데이터 추가
